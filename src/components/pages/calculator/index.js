                  ...
                  {info ? (
                    info === "endowment" ? (
                      ...
                      <p className="info-para">
                        ...
                        assured in intervals during the policy term. Here you
                        will receive the remaining sum assured and bonus at
                        maturity."
                      </p>
                    ) : info === "children" ? (
                      <p className="info-para">
                        ...
                        of a nominee. This gives parents the opportunity to
                        secure the child’s future. In the market this plan is
                        also known as education plan because this plan lets you
                        save money for your child’s further education."
                      </p>
                    ) : info === "whole-life" ? (
                      <p className="info-para">
                        "Whole life insurance is a policy which gives the
                        insurer coverage for lifetime while paying premium for
                        limited number of years. At maturity accumulated bonus
                        and sum assured is paid back"
                      </p>
                    ) : info === "couple" ? (
                      <p className="info-para">
                        "Couple- plan is designed to give coverage to both
                        spouses as well as return on maturity. Here you will be
                        paid sum assured and accumulated bonus at maturity, and
                        if one of the spouses dies during the policy, they will
                        receive death benefits likewise."
                      </p>
                ...
                <div className="leftage_section">
                  ...
                  <Input
                    ...
                    style={{
                      ...
                      marginLeft: 20,
                      boxShadow:
                        childAge > 17 ? "rgb(255 0 0) 3px 2px 13px" : "",
                    }}
                  />
                </div>
